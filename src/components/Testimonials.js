          ...
          <ul>
            <Slider {...settings}>
              <li>
                <blockquote>
                  <p>
                    Won 2 nd place in Paper Presentation on Thermionic Emissions
                    at PSG College.
                  </p>
                </blockquote>
              </li>
              <li>
                <blockquote>
                  <p>
                    President of ISHRAE student’s chapter in PSG college of
                    Technology for 2019-20.
                  </p>
                </blockquote>
              </li>
              <li>
                <blockquote>
                  <p>
                    Organized 46 th National conference on Fluid Mechanics and
                    Fluid Power in Dec, 2019.
                  </p>
                </blockquote>
              </li>
              <li>
                <blockquote>
                  <p>
                    Won 1 st place in ISHRAE A-Quest South India level Quiz
                    Competition in Dec, 2019.
                  </p>
                </blockquote>
              </li>
            </Slider>
